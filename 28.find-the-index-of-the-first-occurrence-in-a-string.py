...
class Solution:
    ...
    #     """ Approach 1: Sliding Window O(nm), O(1) """
    #     m = len(needle)
    #     n = len(haystack)
    ...
    # def strStr(self, haystack: str, needle: str) -> int:
    #     """ Approach 2: Rabin-Karp Algorithm (Single Hash) O(nm), O(1) """
    #     m = len(needle)
    #     n = len(haystack)
    #     if n < m:
    #         return -1
    ...
    # def strStr(self, haystack: str, needle: str) -> int:
    #     """ Approach 3: Rabin-Karp algorithm (Double Hash) O(n), O(1) """
    #     m = len(needle)
    #     n = len(haystack)
    ...
    # def strStr(self, haystack: str, needle: str) -> int:
    #     """ Approach 4: Knuth–Morris–Pratt Algorithm O(n), O(m) """
    #     m = len(needle)
    #     n = len(haystack)
