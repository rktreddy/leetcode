...
class Solution:
    ...
    # def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
    #     """ Approach 1a: Recursive Approach O(N), O(H) """
    ...
    # def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
    #     """ practice: Approach 1a: Recursive Approach O(N), O(H) """
    #     if root is None or root == p or root == q:
    #         return root
    ...
    # def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
    #     """ Approach 1b: Recursive Approach O(N), O(H) """
    #     if root is None or root == p or root == q:
    #         return root
    ...
    # def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
    #     """ practice: Approach 1b: Recursive Approach O(N), O(H) """
    ...
    # def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
    #     """ Approach 2: Iterative using parent pointers O(N), O(N) """
    ...
    # """ Approach 3: Iterative without parent pointers O(N), O(N) """
