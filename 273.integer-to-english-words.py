...
class Solution:
    ...
    #     """ Approach 1: Recursive Approach O(log10(n)), O(log10(n)) """
    ...
    # def numberToWords(self, num: int) -> str:
    #     """ Approach 2: Iterative Approach O(log10(n)), O(1)"""
    #     # Handle the special case where the number is zero
    #     if num == 0:
    #         return "Zero"
    ...
    # def numberToWords(self, num: int) -> str:
    #     """ Approach 3: Pair-Based Approach O(K), O(log10(N)): K - # pairs, N is number"""
    #     if num == 0:
    #         return "Zero"
    ...
    def numberToWords(self, num: int) -> str:
        """ practice: Approach 3: Pair-Based Approach O(K), O(log10(N)): K - # pairs, N is number"""
        if num == 0:
            return "Zero"
